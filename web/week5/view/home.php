  ...
  <body>
    ...
    <div class="container text-center">    
      ...
      <div class="row">
        <div class="col-sm-4">
          <div class="card">
            <img class="card-img-top" src="../images/Saddle4.jpg" width="100%" alt="Black dressage saddle">
            <div class="card-body">
        ...
        <div class="col-sm-4"> 
          <img src="../images/Bridle5.jfif" class="img-responsive" style="width:100%" alt="Chestnut horse with bridle">
          <p>Bridles</p>
          <a href="shop.php" class="btn btn-primary">SHOP NOW</a>    
        </div>
        <div class="col-sm-4">
          <img src="../images/Blanket6.jfif" class="img-responsive" style="width:100%" alt="Bay horse with blue blanket">
          <p>Blankets</p>
          <a href="shop.php" class="btn btn-primary">SHOP NOW</a>
        </div>
      </div>
