        ...
        <div class="col-md-6 well">
          <div><h4>Write a Review</h4></div>
            <form id="reviewForm" method ="POST" action="../support/insert_review.php">
              <input class="form-control" type="text" name="user_name" placeholder="<?php if (isset($_SESSION['username'])) {echo $_SESSION['username'];} else echo 'Enter your username';?>" required>
              <div class="stars">
